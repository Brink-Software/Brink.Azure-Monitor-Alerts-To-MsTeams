...
This repo contains an http triggered Azure Function (V4/.Net 6) that posts a notification using message cards in a designated Microsoft Teams channel when an Azure Monitor alert is fired.
